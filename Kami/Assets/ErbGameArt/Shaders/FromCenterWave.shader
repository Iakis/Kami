Shader "ErbGameArt/Projector/Additive/FromCenterWave" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 emissive = (MainTexvar.rgb*i.vertexColor.rgb*_TintColor.rgb*_Emission*saturate((node_3473+saturate((1.0 - length(abs((node_6035/(_MoveCirle*0.13)))))))));
